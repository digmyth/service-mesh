...
注册gitlab-runner
```
gitlab-runner  register --non-interactive --executor "shell"  --url http://gitlab.done.com:8085/  --registration-token "iKFYZpD3-a9tWDHdBGMn" \
   --description"runner test" --tag-list  "build,deploy" --run-untagged=true --locked=false --access-level "not_protected"
```
